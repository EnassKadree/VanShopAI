...
class DistDoneOrdersPage extends StatelessWidget 
{
  const DistDoneOrdersPage({super.key});

  @override
  Widget build(BuildContext context) 
  {
    final cubit = BlocProvider.of<GetOrdersCubit>(context);
    cubit.getOrders(distributorsConst, true);
    return Scaffold
    (
      body: Padding
      (
          ...
          [
            ...
            (
              builder: (context, state) 
              {
                  ...
                  (
                    ...
                    (
                      ...
                      children: [
                        ...
                        TextButton(
                            onPressed: () async {
                              await cubit.getOrders(distributorsConst, true);
                            },
                            child: Text
                            (
                              'حاول مرة أخرى',
                ...
                return OrdersListView(orders: cubit.doneOrders, sender: distributorsConst,);
              },
            )
          ],
        ),
