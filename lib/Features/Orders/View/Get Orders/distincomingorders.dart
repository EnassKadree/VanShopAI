...
import 'package:vanshopai/Features/Orders/View/Add%20Order/adddistorderpage.dart';
...
class DistIncomingOrdersPage extends StatelessWidget 
{
  ...
  Widget build(BuildContext context) 
  {
    ...
    cubit.getOrders(distributorsConst, false);
    return Scaffold
    (
                    ...
                    (
                      ...
                      children: [
                        ...
                        TextButton(
                            onPressed: () async 
                            {
                              await cubit.getOrders(distributorsConst,false);
                            },
                            child: Text
                            (
                              'حاول مرة أخرى',
