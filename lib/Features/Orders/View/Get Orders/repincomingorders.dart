...
class RepIncomingOrdersPage extends StatelessWidget 
{
  const RepIncomingOrdersPage({super.key});

  @override
  Widget build(BuildContext context) 
  {
    final cubit = BlocProvider.of<GetOrdersCubit>(context);
    cubit.getOrders(representativeConst,false);
    return Scaffold
    (
      body: Padding
      (
          ...
          [
            ...
            (
              builder: (context, state) 
              {
                  ...
                  (
                    ...
                    (
                      ...
                      children: [
                        ...
                        TextButton(
                            onPressed: () async {
                              await cubit.getOrders(representativeConst,false);
                            },
                            child: Text
                            (
                              'حاول مرة أخرى',
                ...
                return OrdersListView(orders: cubit.incomingOrders, sender: representativeConst,);
              },
            )
          ],
        ),
