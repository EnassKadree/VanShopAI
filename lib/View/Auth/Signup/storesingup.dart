...
import 'package:vanshopai/View/Auth/Other/checkstorecategories.dart';
              ...
              (
                ...
                (
                  ...
                  [
                    ...
                    Row(children: 
                    [
                      Text('إنشاء حساب صاحب متجر',style: TextStyle(color: Colors.orange[700]!, fontSize: 25),),
                    ],),
                    const SizedBox(
                      height: 20,
                    ),
                    ...
                    CustomButton(
                      ...
                      onTap: ()
                      {
                        navigateTo(context, CheckStoreCategory());
                      },
                    ),
                    const SizedBox(
                      height: 16,
